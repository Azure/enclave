...
@description('List of principal objects for community maintenance mode access. Off example: "principals": []. Enabled example: "principals": [{"id":"<your-user-object-id>","type":"User"}].')
